    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('IKPU')->sortable()->toggleable(),
                TextColumn::make('pay_web')->sortable()->toggleable(),
                TextColumn::make('offer')->sortable()->toggleable(),
                TextColumn::make('shipping')->sortable()->toggleable(),
